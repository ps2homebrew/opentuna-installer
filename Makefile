...
EE_OBJS += opl_elf.o ule_elf.o apps_icn.o apps_sys.o OpenTuna_sys.o OpenTuna_SLIMS.o OpenTuna_FAT-170.o OpenTuna_FAT-110-120-150-160.o
EE_SRC =   opl_elf.s ule_elf.s apps_icn.s apps_sys.s OpenTuna_sys.s  OpenTuna_SLIMS.s OpenTuna_FAT-170.s OpenTuna_FAT-110-120-150-160.s
...
clean:
	rm -fr *.o $(EE_BIN_PACKED) $(EE_BIN_STRIPPED) $(EE_BIN) OpenTuna_SLIMS.* OpenTuna_sys.* opl_elf.* ule_elf.* apps_icn.* apps_sys.* OpenTuna_FAT-110-120-150-160.* OpenTuna_FAT-170.*
